...
public class SistemaEstudiantesApp {
    public static void main(String[] args) {
        ...
        //Se crea una instansia de la clase servicio, esto lo hacemos fuera del ciclo
        var estudianteDao = new EstudianteDAO();//Esta instancia debe hacerse una vez
        while (!salir){
            try {
                mostrarMenu();//Mostramos el menu
                //Este será el método ejecutarOpciones que devolverá un booleano
                salir = ejecutarOpciones(consola, estudianteDao);//Este arroja una exepción
            } catch (Exception e) {
    ...
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDAO){
        ...
        switch (opcion){
            case 1 -> {//Listar estudiantes
                ...
                //no muestra la información, solo recupera la información y regresa una lista
            ...
            case 4 -> {//Modificar estudiante
                ...
                var idEstudianten = Integer.parseInt(consola.nextLine());
                System.out.println("Nombre: ");
                var nombre = consola.nextLine();
                System.out.println("Apellido: ");
                var apellido = consola.nextLine();
                ...
                var estudiante = new Estudiante(idEstudianten, nombre,apellido, telefono, email);
