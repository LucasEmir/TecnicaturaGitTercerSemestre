...
public class EstudianteDAO {
    ...
    public List<Estudiante> listarEstudiantes(){
        ...
        PreparedStatement ps;//Envia la sentencia sql
        ResultSet rs;//Guarda el resultado de la consulta
        //Creamos un objeto de tipo conección
        ...
        try{
            ...
            try {
                ...
                System.out.println("Ocurrió un error al cerrar la conección "+e.getMessage());
            }
        }//Fin finally
        return estudiantes;
    }//Fin método listar
    ...
    //Eliminar estudiante con el id 3
//    var estudianteEliminar = new Estudiantes(4);
